...
function testRequire(name) {
  ...
  // }
  if (name === '@babel/runtime-corejs3/core-js/map') {
    return require('@babel/runtime-corejs3/core-js/map');
  } else if (name === '@babel/runtime-corejs3/core-js/set') {
    return require('@babel/runtime-corejs3/core-js/set');
  ...
  } else if (name === '@babel/runtime-corejs3/core-js/get-iterator') {
    return require('@babel/runtime-corejs3/core-js/get-iterator');
  } else if (name === '@babel/runtime-corejs3/core-js/symbol') {
    return require('@babel/runtime-corejs3/core-js/symbol');
  } else if (name === '@babel/runtime-corejs3/core-js/symbol/iterator') {
    return require('@babel/runtime-corejs3/core-js/symbol/iterator');
  } else if (name === '@babel/runtime-corejs3/core-js/object/assign') {
    return require('@babel/runtime-corejs3/core-js/object/assign');
  } else if (name === '@babel/runtime-corejs3/core-js/object/get-prototype-of') {
    return require('@babel/runtime-corejs3/core-js/object/get-prototype-of');
  } else if (name === '@babel/runtime-corejs3/core-js/object/keys') {
    return require('@babel/runtime-corejs3/core-js/object/keys');
  } else if (name === '@babel/runtime-corejs3/core-js/promise') {
    return require('@babel/runtime-corejs3/core-js/promise');
