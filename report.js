...
/***/ function(module, exports, __webpack_require__) {
	...
	var filter = JSON.parse(localStorage.getItem('filter') || '{}'); /*global REPORT_DATA, localStorage */
	...
	(0, _jquery2.default)(function () {
	  ...
	  filterUI();
	  (0, _jquery2.default)('.initial-hide').removeClass('initial-hide');
	});

	function renderList(id, list) {
	  list = list.map(function (implementation) {
	    return implementation.dash ? '<li role="separator" class="divider"></li>' : '<li><a href="#" data-' + id + '="' + implementation.selector + '">\n        ' + implementation.name + '\n      </a></li>';
	  }).join('');

	  (0, _jquery2.default)('.js-' + id + '-list').html(list).on('click', 'a', function (e) {
	...
	function filterUI() {
	  ...
	  toggleMatching((0, _jquery2.default)('tbody th'), filter.implementation);
	  ...
	  toggleMatching((0, _jquery2.default)('tbody td'), toShow);

	  // Update the selected indicators
	  (0, _jquery2.default)('.dropdown').find('.glyphicon').remove();
	  if (filter.engine) {
	    (0, _jquery2.default)('[data-engine="' + filter.engine + '"]').prepend('<span class="glyphicon glyphicon-ok"></span>');
	  }
	  if (filter.implementation) {
	    (0, _jquery2.default)('[data-implementation="' + filter.implementation + '"]').prepend('<span class="glyphicon glyphicon-ok"></span>');
	  }
	}
