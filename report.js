...
/***/ (function(module, exports, __webpack_require__) {
	...
	var filter = hasStorage ? JSON.parse(localStorage.getItem('filter') || '{}') : {};
	$(function () {
	...
	function renderList(id, list) {
	  list = list.map(function (_ref) {
	    var dash = _ref.dash,
	        selector = _ref.selector,
	        name = _ref.name;
	    return dash ? "<li role=\"separator\" class=\"divider\"></li>" : "<li><a href=\"#\" data-".concat(id, "=\"").concat(selector, "\">\n      ").concat(name, "\n    </a></li>");
	  }).join('');
	  $(".js-".concat(id, "-list")).html(list).on('click', 'a', function (e) {
	    var $target = $(e.target);
	    var clazz = $target.data(id);
	...
	function filterUI() {
	  ...
	  toggleMatching($('thead').find('th'), filter.engine); // Update the row headers

	  toggleMatching($('tbody th'), filter.implementation); // Update the cells

	  var toShow = '';

	  if (filter.implementation) {
	    toShow += ".".concat(filter.implementation);
	  }

	  if (filter.engine) {
	    toShow += ".".concat(filter.engine);
	  }

	  toggleMatching($('tbody td'), toShow); // Update the selected indicators

	  $('.dropdown').find('.glyphicon').remove();

	  if (filter.engine) {
	    $("[data-engine=\"".concat(filter.engine, "\"]")).append('<span class="glyphicon glyphicon-ok"></span>');
	  }

	  if (filter.implementation) {
	    $("[data-implementation=\"".concat(filter.implementation, "\"]")).append('<span class="glyphicon glyphicon-ok"></span>');
	  }
	}
	...
	function toggleColspan(to, from) {
	  $("thead > tr:first-of-type > th[".concat(from, "]")).each(function () {
	    var $el = $(this); // Node is distinct in that all of it's tested versions are stable.
	...
	function toggleMatching($el, filterClass) {
	  if (filterClass) {
	    if (!/\./.test(filterClass)) {
	      filterClass = ".".concat(filterClass);
	    }

	    $el.filter("".concat(filterClass)).show();
	    $el.filter(":not([rowspan],".concat(filterClass, ")")).hide();
	  } else {
	    $el.show();
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(8);
	var $pad = __webpack_require__(258);
	var userAgent = __webpack_require__(213);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(27).f('asyncIterator');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(8);
	var $values = __webpack_require__(267)(false);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// https://github.com/tc39/proposal-object-values-entries
	var $export = __webpack_require__(8);
	var $entries = __webpack_require__(267)(true);
